...
function Document({ document }) {
  return (
    <>
      ...
      >
        <Container w='190px' display='flex' p={0} flexDirection='column' alignItems='stretch'>
          <Container display='flex' p={0} flexDirection='flex-start'>
            <Container pl={0} w='10%'>
            ...
            <Text fontSize='16px' w='90%' noOfLines={1} align="center" >{document.name}</Text>
          </Container>
