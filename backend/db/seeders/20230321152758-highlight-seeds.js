    ...
    return queryInterface.bulkInsert('Highlights', [
      {
        ...
        type: "text",
        contentText: "The analysis indicates that TS applications exhibit significantly better code quality and understandability than JS applications.",
        comment: "Better code!",
      ...
      },
      {
        id: "7523977432979492",
        type: "text",
        contentText: "Frequently used instruments to evaluate code quality are code smells, i.e., indicators of low code quality which may impact maintainability",
      ...
      },
      {
        id: "9298580906684795",
        type: "text",
        contentText: "We examined a total of 604 repositories (299 JS, 305 TS) with over 16M lines of code.",
      ...
      },
      {
        ...
        type: "text",
        contentText: "SSA",
        boundingRectX1: 816.4599609375,
        boundingRectY1: 360.1875,
        boundingRectX2: 848.4677734375,
        boundingRectY2: 380.1875,
        boundingRectWidth: 1019.9999999999999,
        boundingRectHeight: 1319.9999999999998,
        boundingRectPageNumber: 1,
        comment: "Static Single Assignment",
        docUrl: "https://tinyurl.com/23pybv5e",
        createdAt: new Date(),
        updatedAt: new Date(),
      }
    ], {});
